...
$VCFLIB/vcffilter -f "VT = SNP" -f "AC > 5" -r 11:61000000-62000000 $VCF > ALL.chr11.tmp.vcf
...
# fads region for haplotype network? as exercise?
rm $VCF $VCF.tbi ALL.chr11.tmp.vcf
